...
export const GITHUB_CONFIG = {
    OWNER: process.env.NEXT_PUBLIC_GITHUB_OWNER || 'qiaowenjie124',
    REPO: process.env.NEXT_PUBLIC_GITHUB_REPO || 'qiaowenjie',
    BRANCH: process.env.NEXT_PUBLIC_GITHUB_BRANCH || 'main',
    APP_ID: process.env.NEXT_PUBLIC_GITHUB_APP_ID || '3652997',
